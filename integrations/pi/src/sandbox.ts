...
export function createSandboxTools(
	...
	// Pi's grep tool spawns ripgrep on the host whatever operations it is given,
	// so the sandbox version replaces execute and runs grep inside the sandbox.
	...
	const grep = {
		...
		execute: async (
			...
			// grep exits 1 when nothing matched and 2 on error.
