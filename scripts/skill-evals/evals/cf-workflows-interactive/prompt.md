Fetch the Cloudflare workflows-starter-template into `./original-template` with:

`/opt/homebrew/opt/node@22/bin/npx giget gh:cloudflare/templates/workflows-starter-template#30d1642da7e2b42913dc63a4a5ffca9bb01b9679 ./original-template`
