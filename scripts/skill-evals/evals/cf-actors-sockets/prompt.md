Fetch the @cloudflare/actors sockets example into `./original-template` with:

`/opt/homebrew/opt/node@22/bin/npx giget gh:cloudflare/actors/examples/sockets#6bbf82b239016ecb205d3b40ff1aa9b8c88b2fa7 ./original-template`
