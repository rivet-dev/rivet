Fetch the PartyKit socket.io-chat example into `./original-template` with:

`/opt/homebrew/opt/node@22/bin/npx giget gh:partykit/partykit/examples/socket.io-chat#5527a744d25ff051a204806b85af504cb0fe2f7b ./original-template`
