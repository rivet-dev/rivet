Fetch the Cloudflare D1 template into `./original-template` with:

`/opt/homebrew/opt/node@22/bin/npx giget gh:cloudflare/templates/d1-template#30d1642da7e2b42913dc63a4a5ffca9bb01b9679 ./original-template`

Then migrate it from Cloudflare D1 to RivetKit.
