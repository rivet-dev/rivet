...
pub struct RunnerConfigResponse {
    ...
    pub runner_pool_error: Option<Option<Box<models::RunnerPoolError>>>,
}

impl RunnerConfigResponse {
    pub fn new(normal: serde_json::Value, serverless: models::RunnerConfigKindOneOf1Serverless) -> RunnerConfigResponse {
