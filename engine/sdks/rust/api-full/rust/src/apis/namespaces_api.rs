...
pub async fn namespaces_list(configuration: &configuration::Configuration, limit: Option<i32>, cursor: Option<&str>, name: Option<&str>, namespace_ids: Option<&str>, namespace_id: Option<Vec<String>>) -> Result<models::NamespaceListResponse, Error<NamespacesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_cursor = cursor;
    let p_name = name;
