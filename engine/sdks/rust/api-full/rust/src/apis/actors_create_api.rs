...
pub async fn actors_create(configuration: &configuration::Configuration, namespace: &str, actors_create_request: models::ActorsCreateRequest) -> Result<models::ActorsCreateResponse, Error<ActorsCreateError>> {
