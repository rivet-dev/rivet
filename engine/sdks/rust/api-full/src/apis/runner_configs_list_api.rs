...
pub async fn runner_configs_list(
	...
	limit: Option<i32>,
	cursor: Option<&str>,
	variant: Option<models::RunnerConfigVariant>,
	runner_names: Option<&str>,
	runner_name: Option<Vec<String>>,
) -> Result<models::RunnerConfigsListResponse, Error<RunnerConfigsListError>> {
	...
	if let Some(ref param_value) = p_runner_name {
		req_builder = match "multi" {
			"multi" => req_builder.query(
				&param_value
					.into_iter()
					.map(|p| ("runner_name".to_owned(), p.to_string()))
