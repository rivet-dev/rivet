...
pub async fn runner_configs_serverless_health_check(
	...
	namespace: &str,
	runner_configs_serverless_health_check_request: models::RunnerConfigsServerlessHealthCheckRequest,
) -> Result<
	models::RunnerConfigsServerlessHealthCheckResponse,
	Error<RunnerConfigsServerlessHealthCheckError>,
> {
	// add a prefix to parameters to efficiently prevent name collisions
	let p_namespace = namespace;
	let p_runner_configs_serverless_health_check_request =
		runner_configs_serverless_health_check_request;
	...
	if !status.is_client_error() && !status.is_server_error() {
		...
		let content = resp.text().await?;
		let entity: Option<RunnerConfigsServerlessHealthCheckError> =
