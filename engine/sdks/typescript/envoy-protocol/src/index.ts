...
export function writeKvListRangeQuery(
	bc: bare.ByteCursor,
	x: KvListRangeQuery,
): void {
...
export function writeKvListPrefixQuery(
	bc: bare.ByteCursor,
	x: KvListPrefixQuery,
): void {
	writeKvKey(bc, x.key);
...
export function writeKvListRequest(
	bc: bare.ByteCursor,
	x: KvListRequest,
): void {
...
export function writeKvDeleteRequest(
	bc: bare.ByteCursor,
	x: KvDeleteRequest,
): void {
	write0(bc, x.keys);
...
export function readKvDeleteRangeRequest(
	bc: bare.ByteCursor,
...
export function writeKvDeleteRangeRequest(
	bc: bare.ByteCursor,
	x: KvDeleteRangeRequest,
): void {
	writeKvKey(bc, x.start);
	writeKvKey(bc, x.end);
}
...
export function writeKvErrorResponse(
	bc: bare.ByteCursor,
	x: KvErrorResponse,
): void {
...
export function writeKvGetResponse(
	bc: bare.ByteCursor,
	x: KvGetResponse,
): void {
	write0(bc, x.keys);
...
export function writeKvListResponse(
	bc: bare.ByteCursor,
	x: KvListResponse,
): void {
	write0(bc, x.keys);
	...
	switch (tag) {
		...
		case 4:
			return {
				...
				val: readKvDeleteRangeRequest(bc),
			};
		case 5:
...
export function writeKvRequestData(
	bc: bare.ByteCursor,
	x: KvRequestData,
): void {
	switch (x.tag) {
...
export function writeKvResponseData(
	bc: bare.ByteCursor,
	x: KvResponseData,
): void {
	switch (x.tag) {
...
export function writeSqliteGeneration(
	bc: bare.ByteCursor,
	x: SqliteGeneration,
): void {
	bare.writeU64(bc, x);
...
export function writeSqlitePageBytes(
	bc: bare.ByteCursor,
	x: SqlitePageBytes,
): void {
	bare.writeData(bc, x);
...
export function writeSqliteDirtyPage(
	bc: bare.ByteCursor,
	x: SqliteDirtyPage,
): void {
...
export function writeSqliteFetchedPage(
	bc: bare.ByteCursor,
	x: SqliteFetchedPage,
): void {
	writeSqlitePgno(bc, x.pgno);
...
export function readSqliteGetPagesRequest(
	bc: bare.ByteCursor,
...
export function writeSqliteGetPagesRequest(
	bc: bare.ByteCursor,
	x: SqliteGetPagesRequest,
): void {
...
export function writeSqliteGetPagesOk(
	bc: bare.ByteCursor,
	x: SqliteGetPagesOk,
): void {
	write7(bc, x.pages);
...
export function readSqliteErrorResponse(
	bc: bare.ByteCursor,
): SqliteErrorResponse {
	return {
...
export function writeSqliteErrorResponse(
	bc: bare.ByteCursor,
	x: SqliteErrorResponse,
): void {
...
export function readSqliteGetPagesResponse(
	bc: bare.ByteCursor,
): SqliteGetPagesResponse {
	const offset = bc.offset;
	const tag = bare.readU8(bc);
	switch (tag) {
		case 0:
		...
		case 1:
			return {
				tag: "SqliteErrorResponse",
				val: readSqliteErrorResponse(bc),
			};
		default: {
			bc.offset = offset;
			throw new bare.BareError(offset, "invalid tag");
...
export function writeSqliteGetPagesResponse(
	bc: bare.ByteCursor,
	x: SqliteGetPagesResponse,
): void {
	switch (x.tag) {
...
export function readSqliteCommitRequest(
	bc: bare.ByteCursor,
): SqliteCommitRequest {
	return {
		actorId: readId(bc),
...
export function writeSqliteCommitRequest(
	bc: bare.ByteCursor,
	x: SqliteCommitRequest,
): void {
	writeId(bc, x.actorId);
...
export function writeSqliteCommitOk(
	bc: bare.ByteCursor,
	x: SqliteCommitOk,
): void {
	write2(bc, x.headTxid);
...
export function readSqliteCommitResponse(
	bc: bare.ByteCursor,
...
export function writeSqliteCommitResponse(
	bc: bare.ByteCursor,
	x: SqliteCommitResponse,
): void {
	switch (x.tag) {
		case "SqliteCommitOk": {
			bare.writeU8(bc, 0);
...
export function readSqliteValueInteger(
	bc: bare.ByteCursor,
): SqliteValueInteger {
	return {
...
export function writeSqliteValueInteger(
	bc: bare.ByteCursor,
	x: SqliteValueInteger,
): void {
...
export function writeSqliteValueFloat(
	bc: bare.ByteCursor,
	x: SqliteValueFloat,
): void {
...
export function writeSqliteValueText(
	bc: bare.ByteCursor,
	x: SqliteValueText,
): void {
...
export function writeSqliteValueBlob(
	bc: bare.ByteCursor,
	x: SqliteValueBlob,
): void {
...
export function readSqliteBindParam(bc: bare.ByteCursor): SqliteBindParam {
	...
	switch (tag) {
		...
		case 1:
			return {
				tag: "SqliteValueInteger",
				val: readSqliteValueInteger(bc),
			};
		case 2:
...
export function writeSqliteBindParam(
	bc: bare.ByteCursor,
	x: SqliteBindParam,
): void {
	switch (x.tag) {
...
export function writeSqliteColumnValue(
	bc: bare.ByteCursor,
	x: SqliteColumnValue,
): void {
	switch (x.tag) {
...
function read11(
	bc: bare.ByteCursor,
): readonly (readonly SqliteColumnValue[])[] {
	const len = bare.readUintSafe(bc);
	if (len === 0) {
		return [];
	}
...
function write11(
	bc: bare.ByteCursor,
	x: readonly (readonly SqliteColumnValue[])[],
): void {
	bare.writeUintSafe(bc, x.length);
	for (let i = 0; i < x.length; i++) {
		write10(bc, x[i]);
...
export function writeSqliteQueryResult(
	bc: bare.ByteCursor,
	x: SqliteQueryResult,
): void {
	write9(bc, x.columns);
...
export function readSqliteExecuteResult(
	bc: bare.ByteCursor,
): SqliteExecuteResult {
	return {
		columns: read9(bc),
...
export function writeSqliteExecuteResult(
	bc: bare.ByteCursor,
	x: SqliteExecuteResult,
): void {
	write9(bc, x.columns);
	write11(bc, x.rows);
...
export function writeSqliteExecRequest(
	bc: bare.ByteCursor,
	x: SqliteExecRequest,
): void {
...
function write14(
	bc: bare.ByteCursor,
	x: readonly SqliteBindParam[] | null,
): void {
	bare.writeBool(bc, x != null);
	if (x != null) {
		write13(bc, x);
...
export function readSqliteExecuteRequest(
	bc: bare.ByteCursor,
...
export function writeSqliteExecuteRequest(
	bc: bare.ByteCursor,
	x: SqliteExecuteRequest,
): void {
	writeId(bc, x.namespaceId);
	writeId(bc, x.actorId);
	writeSqliteGeneration(bc, x.generation);
...
export function writeSqliteExecuteOk(
	bc: bare.ByteCursor,
	x: SqliteExecuteOk,
): void {
...
export function readSqliteExecResponse(
	bc: bare.ByteCursor,
): SqliteExecResponse {
	const offset = bc.offset;
	const tag = bare.readU8(bc);
...
export function writeSqliteExecResponse(
	bc: bare.ByteCursor,
...
export function readSqliteExecuteResponse(
	bc: bare.ByteCursor,
...
export function writeSqliteExecuteResponse(
	bc: bare.ByteCursor,
	x: SqliteExecuteResponse,
): void {
	switch (x.tag) {
...
export function writeActorCheckpoint(
	bc: bare.ByteCursor,
	x: ActorCheckpoint,
): void {
	writeId(bc, x.actorId);
...
export function writeActorStateStopped(
	bc: bare.ByteCursor,
	x: ActorStateStopped,
): void {
...
export function writeEventActorIntent(
	bc: bare.ByteCursor,
	x: EventActorIntent,
): void {
...
export function readEventActorStateUpdate(
	bc: bare.ByteCursor,
...
export function writeEventActorStateUpdate(
	bc: bare.ByteCursor,
	x: EventActorStateUpdate,
): void {
...
export function readEventActorSetAlarm(
	bc: bare.ByteCursor,
): EventActorSetAlarm {
	return {
		alarmTs: read12(bc),
...
export function writeEventActorSetAlarm(
	bc: bare.ByteCursor,
	x: EventActorSetAlarm,
): void {
	...
	switch (tag) {
		...
		case 1:
			return {
				...
				val: readEventActorStateUpdate(bc),
			};
		case 2:
			return {
				tag: "EventActorSetAlarm",
				val: readEventActorSetAlarm(bc),
			};
		default: {
			bc.offset = offset;
			throw new bare.BareError(offset, "invalid tag");
...
export function writePreloadedKvEntry(
	bc: bare.ByteCursor,
	x: PreloadedKvEntry,
): void {
	writeKvKey(bc, x.key);
...
export function readHibernatingRequest(
	bc: bare.ByteCursor,
): HibernatingRequest {
	return {
...
export function writeHibernatingRequest(
	bc: bare.ByteCursor,
	x: HibernatingRequest,
): void {
...
export function writeCommandStartActor(
	bc: bare.ByteCursor,
	x: CommandStartActor,
): void {
...
export function writeStopActorReason(
	bc: bare.ByteCursor,
	x: StopActorReason,
): void {
	switch (x) {
...
export function writeCommandStopActor(
	bc: bare.ByteCursor,
	x: CommandStopActor,
): void {
...
export function writeCommandWrapper(
	bc: bare.ByteCursor,
	x: CommandWrapper,
): void {
	writeActorCheckpoint(bc, x.checkpoint);
...
export function readActorCommandKeyData(
	bc: bare.ByteCursor,
): ActorCommandKeyData {
	const offset = bc.offset;
	const tag = bare.readU8(bc);
...
export function writeActorCommandKeyData(
	bc: bare.ByteCursor,
	x: ActorCommandKeyData,
): void {
	switch (x.tag) {
		case "CommandStartActor": {
			bare.writeU8(bc, 0);
...
export function encodeActorCommandKeyData(
	x: ActorCommandKeyData,
	config?: Partial<bare.Config>,
): Uint8Array {
...
export function decodeActorCommandKeyData(
	bytes: Uint8Array,
): ActorCommandKeyData {
...
export function readToEnvoyRequestStart(
	bc: bare.ByteCursor,
): ToEnvoyRequestStart {
	return {
		actorId: readId(bc),
...
export function writeToEnvoyRequestStart(
	bc: bare.ByteCursor,
	x: ToEnvoyRequestStart,
): void {
	writeId(bc, x.actorId);
...
export function readToEnvoyRequestChunk(
	bc: bare.ByteCursor,
): ToEnvoyRequestChunk {
	return {
...
export function writeToEnvoyRequestChunk(
	bc: bare.ByteCursor,
	x: ToEnvoyRequestChunk,
): void {
...
export function readToRivetResponseStart(
	bc: bare.ByteCursor,
...
export function writeToRivetResponseStart(
	bc: bare.ByteCursor,
	x: ToRivetResponseStart,
): void {
...
export function readToRivetResponseChunk(
	bc: bare.ByteCursor,
...
export function writeToRivetResponseChunk(
	bc: bare.ByteCursor,
	x: ToRivetResponseChunk,
): void {
	bare.writeData(bc, x.body);
	bare.writeBool(bc, x.finish);
}
...
export function readToEnvoyWebSocketOpen(
	bc: bare.ByteCursor,
...
export function writeToEnvoyWebSocketOpen(
	bc: bare.ByteCursor,
	x: ToEnvoyWebSocketOpen,
): void {
	writeId(bc, x.actorId);
	bare.writeString(bc, x.path);
	write20(bc, x.headers);
...
export function readToEnvoyWebSocketMessage(
	bc: bare.ByteCursor,
...
export function writeToEnvoyWebSocketMessage(
	bc: bare.ByteCursor,
	x: ToEnvoyWebSocketMessage,
): void {
...
export function readToEnvoyWebSocketClose(
	bc: bare.ByteCursor,
...
export function writeToEnvoyWebSocketClose(
	bc: bare.ByteCursor,
	x: ToEnvoyWebSocketClose,
): void {
	write21(bc, x.code);
	write15(bc, x.reason);
}
...
export function readToRivetWebSocketOpen(
	bc: bare.ByteCursor,
...
export function writeToRivetWebSocketOpen(
	bc: bare.ByteCursor,
	x: ToRivetWebSocketOpen,
): void {
...
export function readToRivetWebSocketMessage(
	bc: bare.ByteCursor,
...
export function writeToRivetWebSocketMessage(
	bc: bare.ByteCursor,
	x: ToRivetWebSocketMessage,
): void {
	bare.writeData(bc, x.data);
	bare.writeBool(bc, x.binary);
}
...
export function readToRivetWebSocketMessageAck(
	bc: bare.ByteCursor,
...
export function writeToRivetWebSocketMessageAck(
	bc: bare.ByteCursor,
	x: ToRivetWebSocketMessageAck,
): void {
...
export function readToRivetWebSocketClose(
	bc: bare.ByteCursor,
...
export function writeToRivetWebSocketClose(
	bc: bare.ByteCursor,
...
export type ToRivetTunnelMessageKind =
	 ...
	 */
	| {
			readonly tag: "ToRivetResponseStart";
			readonly val: ToRivetResponseStart;
	  }
	| {
			readonly tag: "ToRivetResponseChunk";
			readonly val: ToRivetResponseChunk;
	  }
	| {
	 ...
	 */
	| {
			readonly tag: "ToRivetWebSocketOpen";
			readonly val: ToRivetWebSocketOpen;
	  }
	| {
			readonly tag: "ToRivetWebSocketMessage";
			readonly val: ToRivetWebSocketMessage;
	  }
	| {
			readonly tag: "ToRivetWebSocketMessageAck";
			readonly val: ToRivetWebSocketMessageAck;
	  }
	| {
			readonly tag: "ToRivetWebSocketClose";
			readonly val: ToRivetWebSocketClose;
	  };

export function readToRivetTunnelMessageKind(
	bc: bare.ByteCursor,
	...
	switch (tag) {
		case 0:
			return {
				...
				val: readToRivetResponseStart(bc),
			};
		case 1:
			return {
				tag: "ToRivetResponseChunk",
				val: readToRivetResponseChunk(bc),
			};
		case 2:
		...
		case 3:
			return {
				...
				val: readToRivetWebSocketOpen(bc),
			};
		case 4:
			return {
				tag: "ToRivetWebSocketMessage",
				val: readToRivetWebSocketMessage(bc),
			};
		case 5:
			return {
				tag: "ToRivetWebSocketMessageAck",
				val: readToRivetWebSocketMessageAck(bc),
			};
		case 6:
			return {
				tag: "ToRivetWebSocketClose",
				val: readToRivetWebSocketClose(bc),
			};
		default: {
			bc.offset = offset;
			throw new bare.BareError(offset, "invalid tag");
...
export function writeToRivetTunnelMessageKind(
	bc: bare.ByteCursor,
	x: ToRivetTunnelMessageKind,
): void {
	switch (x.tag) {
...
export function readToRivetTunnelMessage(
	bc: bare.ByteCursor,
...
export function writeToRivetTunnelMessage(
	bc: bare.ByteCursor,
	x: ToRivetTunnelMessage,
): void {
...
export type ToEnvoyTunnelMessageKind =
	 ...
	 */
	| {
			readonly tag: "ToEnvoyWebSocketOpen";
			readonly val: ToEnvoyWebSocketOpen;
	  }
	| {
			readonly tag: "ToEnvoyWebSocketMessage";
			readonly val: ToEnvoyWebSocketMessage;
	  }
	| {
			readonly tag: "ToEnvoyWebSocketClose";
			readonly val: ToEnvoyWebSocketClose;
	  };

export function readToEnvoyTunnelMessageKind(
	bc: bare.ByteCursor,
	...
	switch (tag) {
		case 0:
			return {
				tag: "ToEnvoyRequestStart",
				val: readToEnvoyRequestStart(bc),
			};
		case 1:
			return {
				tag: "ToEnvoyRequestChunk",
				val: readToEnvoyRequestChunk(bc),
			};
		case 2:
			return { tag: "ToEnvoyRequestAbort", val: null };
		case 3:
			return {
				tag: "ToEnvoyWebSocketOpen",
				val: readToEnvoyWebSocketOpen(bc),
			};
		case 4:
			return {
				tag: "ToEnvoyWebSocketMessage",
				val: readToEnvoyWebSocketMessage(bc),
			};
		case 5:
			return {
				tag: "ToEnvoyWebSocketClose",
				val: readToEnvoyWebSocketClose(bc),
			};
		default: {
			bc.offset = offset;
			throw new bare.BareError(offset, "invalid tag");
...
export function writeToEnvoyTunnelMessageKind(
	bc: bare.ByteCursor,
	x: ToEnvoyTunnelMessageKind,
): void {
	switch (x.tag) {
...
export function readToEnvoyTunnelMessage(
	bc: bare.ByteCursor,
...
export function writeToEnvoyTunnelMessage(
	bc: bare.ByteCursor,
	x: ToEnvoyTunnelMessage,
): void {
	writeMessageId(bc, x.messageId);
...
function write23(
	bc: bare.ByteCursor,
	x: ReadonlyMap<string, ActorName> | null,
): void {
	bare.writeBool(bc, x != null);
	if (x != null) {
		write22(bc, x);
...
export function writeToRivetMetadata(
	bc: bare.ByteCursor,
	x: ToRivetMetadata,
): void {
...
export function writeToRivetEvents(
	bc: bare.ByteCursor,
	x: ToRivetEvents,
): void {
	bare.writeUintSafe(bc, x.length);
...
export function writeToRivetAckCommands(
	bc: bare.ByteCursor,
	x: ToRivetAckCommands,
): void {
...
export function writeToRivetKvRequest(
	bc: bare.ByteCursor,
	x: ToRivetKvRequest,
): void {
	writeId(bc, x.actorId);
...
export function readToRivetSqliteGetPagesRequest(
	bc: bare.ByteCursor,
...
export function writeToRivetSqliteGetPagesRequest(
	bc: bare.ByteCursor,
...
export function readToRivetSqliteCommitRequest(
	bc: bare.ByteCursor,
...
export function writeToRivetSqliteCommitRequest(
	bc: bare.ByteCursor,
	x: ToRivetSqliteCommitRequest,
): void {
	bare.writeU32(bc, x.requestId);
...
export function readToRivetSqliteExecRequest(
	bc: bare.ByteCursor,
...
export function writeToRivetSqliteExecRequest(
	bc: bare.ByteCursor,
	x: ToRivetSqliteExecRequest,
): void {
	bare.writeU32(bc, x.requestId);
...
export function readToRivetSqliteExecuteRequest(
	bc: bare.ByteCursor,
...
export function writeToRivetSqliteExecuteRequest(
	bc: bare.ByteCursor,
	x: ToRivetSqliteExecuteRequest,
): void {
	bare.writeU32(bc, x.requestId);
	...
	switch (tag) {
		...
		case 6:
			return {
				...
				val: readToRivetTunnelMessage(bc),
			};
		case 7:
			return {
				tag: "ToRivetSqliteGetPagesRequest",
				val: readToRivetSqliteGetPagesRequest(bc),
			};
		case 8:
			return {
				tag: "ToRivetSqliteCommitRequest",
				val: readToRivetSqliteCommitRequest(bc),
			};
		case 9:
			return {
				tag: "ToRivetSqliteExecRequest",
				val: readToRivetSqliteExecRequest(bc),
			};
		case 10:
			return {
				tag: "ToRivetSqliteExecuteRequest",
				val: readToRivetSqliteExecuteRequest(bc),
			};
		default: {
			bc.offset = offset;
			throw new bare.BareError(offset, "invalid tag");
...
export function writeProtocolMetadata(
	bc: bare.ByteCursor,
	x: ProtocolMetadata,
): void {
...
export function writeToEnvoyCommands(
	bc: bare.ByteCursor,
	x: ToEnvoyCommands,
): void {
	bare.writeUintSafe(bc, x.length);
...
export function writeToEnvoyAckEvents(
	bc: bare.ByteCursor,
	x: ToEnvoyAckEvents,
): void {
...
export function writeToEnvoyKvResponse(
	bc: bare.ByteCursor,
	x: ToEnvoyKvResponse,
): void {
	bare.writeU32(bc, x.requestId);
...
export function readToEnvoySqliteGetPagesResponse(
	bc: bare.ByteCursor,
...
export function writeToEnvoySqliteGetPagesResponse(
	bc: bare.ByteCursor,
	x: ToEnvoySqliteGetPagesResponse,
): void {
	bare.writeU32(bc, x.requestId);
...
export function readToEnvoySqliteCommitResponse(
	bc: bare.ByteCursor,
...
export function writeToEnvoySqliteCommitResponse(
	bc: bare.ByteCursor,
...
export function readToEnvoySqliteExecResponse(
	bc: bare.ByteCursor,
...
export function writeToEnvoySqliteExecResponse(
	bc: bare.ByteCursor,
	x: ToEnvoySqliteExecResponse,
): void {
	bare.writeU32(bc, x.requestId);
...
export function readToEnvoySqliteExecuteResponse(
	bc: bare.ByteCursor,
...
export function writeToEnvoySqliteExecuteResponse(
	bc: bare.ByteCursor,
	x: ToEnvoySqliteExecuteResponse,
): void {
	bare.writeU32(bc, x.requestId);
...
export type ToEnvoy =
	...
	| {
			readonly tag: "ToEnvoyTunnelMessage";
			readonly val: ToEnvoyTunnelMessage;
	  }
	...
	switch (tag) {
		...
		case 4:
			return {
				...
				val: readToEnvoyTunnelMessage(bc),
			};
		case 5:
			return { tag: "ToEnvoyPing", val: readToEnvoyPing(bc) };
		case 6:
			return {
				tag: "ToEnvoySqliteGetPagesResponse",
				val: readToEnvoySqliteGetPagesResponse(bc),
			};
		case 7:
			return {
				tag: "ToEnvoySqliteCommitResponse",
				val: readToEnvoySqliteCommitResponse(bc),
			};
		case 8:
			return {
				tag: "ToEnvoySqliteExecResponse",
				val: readToEnvoySqliteExecResponse(bc),
			};
		case 9:
			return {
...
export function writeToEnvoyConnPing(
	bc: bare.ByteCursor,
	x: ToEnvoyConnPing,
): void {
	writeGatewayId(bc, x.gatewayId);
...
export function encodeToEnvoyConn(
	x: ToEnvoyConn,
	config?: Partial<bare.Config>,
): Uint8Array {
	const fullConfig = config != null ? bare.Config(config) : DEFAULT_CONFIG;
...
export function writeToGatewayPong(
	bc: bare.ByteCursor,
	x: ToGatewayPong,
): void {
	writeRequestId(bc, x.requestId);
...
export function encodeToGateway(
	x: ToGateway,
	config?: Partial<bare.Config>,
): Uint8Array {
	const fullConfig = config != null ? bare.Config(config) : DEFAULT_CONFIG;
...
export function readToOutboundActorStart(
	bc: bare.ByteCursor,
...
export function writeToOutboundActorStart(
	bc: bare.ByteCursor,
	x: ToOutboundActorStart,
): void {
	writeId(bc, x.namespaceId);
...
export type ToOutbound = {
	readonly tag: "ToOutboundActorStart";
	readonly val: ToOutboundActorStart;
};
...
export function readToOutbound(bc: bare.ByteCursor): ToOutbound {
	...
	switch (tag) {
		case 0:
			return {
				tag: "ToOutboundActorStart",
				val: readToOutboundActorStart(bc),
			};
		default: {
			bc.offset = offset;
			throw new bare.BareError(offset, "invalid tag");
...
export function encodeToOutbound(
	x: ToOutbound,
	config?: Partial<bare.Config>,
): Uint8Array {
	const fullConfig = config != null ? bare.Config(config) : DEFAULT_CONFIG;
