...
export class Metadata {
     ...
     */
    public async get(requestOptions?: Metadata.RequestOptions): Promise<Rivet.MetadataGetResponse> {
        ...
        if (_response.ok) {
            return serializers.MetadataGetResponse.parseOrThrow(_response.body, {
