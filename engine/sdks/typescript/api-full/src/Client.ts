...
export class RivetClient {
    ...
    public async actorsReschedule(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: _queryParams,
            requestType: "json",
            body: serializers.ActorsRescheduleBody.jsonOrThrow(_body, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 180000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
    ...
    public async actorsSleep(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: _queryParams,
            requestType: "json",
            body: serializers.ActorsSleepBody.jsonOrThrow(_body, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 180000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
