...
type ActorsRescheduleBody = map[string]interface{}

type ActorsRescheduleResponse = map[string]interface{}

type ActorsSleepBody = map[string]interface{}
