...
impl MetricKey {
	pub fn new(workflow_id: Id, metric: Metric) -> Self {
		MetricKey {
			workflow_id,
			metric,
		}
	...
	pub fn subspace(workflow_id: Id) -> MetricSubspaceKey {
		MetricSubspaceKey::new(workflow_id)
	}
}
