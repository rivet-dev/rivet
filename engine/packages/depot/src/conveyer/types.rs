...
impl OwnedVersionedData for VersionedNamespaceBranchRecord {
	...
	fn deserialize_version(payload: &[u8], version: u16) -> Result<Self> {
		match version {
			1 => Ok(Self::V1(serde_bare::from_slice(payload)?)),
			_ => bail!("invalid depot NamespaceBranchRecord version: {version}"),
		}
	}
...
impl OwnedVersionedData for VersionedNamespacePointer {
	...
	fn deserialize_version(payload: &[u8], version: u16) -> Result<Self> {
		match version {
			1 => Ok(Self::V1(serde_bare::from_slice(payload)?)),
			_ => bail!("invalid depot NamespacePointer version: {version}"),
		}
	}
...
impl OwnedVersionedData for VersionedBookmarkRecord {
	...
	fn deserialize_version(payload: &[u8], version: u16) -> Result<Self> {
		match version {
			1 => Ok(Self::V1(serde_bare::from_slice(payload)?)),
			_ => bail!("invalid depot BookmarkRecord version: {version}"),
		}
	}
...
impl OwnedVersionedData for VersionedPinnedBookmarkRecord {
	...
	fn deserialize_version(payload: &[u8], version: u16) -> Result<Self> {
		match version {
			1 => Ok(Self::V1(serde_bare::from_slice(payload)?)),
			_ => bail!("invalid depot PinnedBookmarkRecord version: {version}"),
		}
	}
