...
pub enum SqliteStorageError {
	...
	#[error(
		"fence_mismatch",
		"SQLite storage debug fence mismatch.",
		"SQLite storage debug fence mismatch: {reason}."
	)]
	...
	#[error(
		"quota_exceeded",
		"Not enough space left in SQLite storage.",
		"Not enough space left in SQLite storage ({remaining_bytes} bytes remaining, current payload is {payload_size} bytes)."
	)]
