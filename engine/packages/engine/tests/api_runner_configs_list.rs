...
fn list_runner_configs_filter_by_name() {
	common::run(common::TestOpts::new(1), |ctx| async move {
		...
		let response = common::api::public::runner_configs_list(
			...
			rivet_api_types::runner_configs::list::ListQuery {
				namespace: namespace.clone(),
				runner_names: Some("filter-test-1,filter-test-2".to_string()),
				variant: None,
				limit: None,
				cursor: None,
			},
...
fn list_runner_configs_non_existent_runner() {
	common::run(common::TestOpts::new(1), |ctx| async move {
		...
		let response = common::api::public::runner_configs_list(
			...
			rivet_api_types::runner_configs::list::ListQuery {
				namespace: namespace.clone(),
				runner_names: Some("non-existent-runner".to_string()),
				variant: None,
				limit: None,
				cursor: None,
			},
...
fn list_runner_configs_validates_returned_data() {
	common::run(common::TestOpts::new(1), |ctx| async move {
		...
		let response = common::api::public::runner_configs_list(
			...
			rivet_api_types::runner_configs::list::ListQuery {
				namespace: namespace.clone(),
				runner_names: Some(runner_name.to_string()),
				variant: None,
				limit: None,
				cursor: None,
			},
