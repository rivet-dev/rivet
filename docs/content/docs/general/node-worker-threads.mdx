...
For TypeScript applications, run compiled JavaScript or use a loader that registers in worker threads. Inheriting Node.js loader flags is not sufficient if the loader only initializes on the main thread.
