...
Read [Authentication](/actors/docs/authentication) first for the two-layer model. This guide is the runnable version of it.
...
- [JWTs](/actors/docs/jwt) for the full grant vocabulary, expiry behavior, and renewal.
