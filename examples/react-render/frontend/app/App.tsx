		...
		<div className="relative flex min-h-screen flex-col bg-background text-foreground">
			...
			<main className="relative z-10 flex min-h-0 flex-1 flex-col items-center justify-center px-4 py-12 sm:px-6">
				...
				<p className="mx-auto mt-4 max-w-xl text-center text-base text-muted-foreground sm:text-lg">
					Type-safe React hooks for Rivet Actors — connect your UI to
					real-time backend state with{" "}
				...
				<div className="mt-10 w-full max-w-md">
					<Card
						variant="elevated"
						className="overflow-hidden border-border shadow-lg shadow-black/5 dark:shadow-black/20"
					>
						...
						<div className="border-b border-border bg-muted/35 px-6 py-10 text-center dark:bg-zinc-950/50">
							...
							<p
								className="mt-3 text-5xl font-bold tabular-nums tracking-tight text-primary sm:text-6xl"
								aria-live="polite"
							>
								{total}
							</p>
				...
				<div className="w-full max-w-md">
					...
					>
						...
						<CardContent className="flex justify-center pt-0">
							<a
								href="https://render.com/deploy?repo=https://github.com/rivet-dev/rivet/tree/main/examples/react-render"
								target="_blank"
