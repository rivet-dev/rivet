...
export default function InteractionScreen({
	...
	const isCurrentTabDisabled =
		activeTab === "events" && state.connectionMode !== "connection";
	...
	const tabs = [
		...
		},
		{
			...
			label: "Events",
			component: EventsTab,
			disabled: state.connectionMode !== "connection",
		},
		{
		...
		{
			id: "raw-http" as const,
			label: "Raw HTTP",
			component: RawHttpTab,
			disabled: false,
		},
		{
			id: "raw-websocket" as const,
			label: "Raw WebSocket",
			component: RawWebSocketTab,
			disabled: false,
		},
		{
	...
	const ActiveTabComponent =
		tabs.find((tab) => tab.id === activeTab)?.component || ActionsTab;
						...
						<div className="connection-details">
							...
							<div className="connection-meta">
								...
								<span className="transport-info">
									{state.encoding.toUpperCase()}
								</span>
								<span
									className={`mode-info ${state.connectionMode}`}
								>
