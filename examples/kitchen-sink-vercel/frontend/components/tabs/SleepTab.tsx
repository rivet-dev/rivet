	...
	if (state.actorName !== "demo") {
		return (
			<div className="section">
				...
				<p>
					Sleep and lifecycle features are only available for the{" "}
		...
		<div>
			<div className="section">
				...
				<p style={{ marginBottom: "15px" }}>
					The <code>sleep()</code> method forces an actor to go
					dormant immediately. This is useful for testing actor
			...
			<div className="section">
				...
				<p style={{ marginBottom: "15px" }}>
					...
					This demonstrates the actor lifecycle across sleep/wake
					cycles.
				</p>
