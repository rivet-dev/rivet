	...
	if (state.actorName !== "demo") {
		return (
			<div className="section">
				<h3>Metadata</h3>
				<p>
					Metadata features are only available for the{" "}
					<code>demo</code> actor. Please select the demo actor in the
					header.
				</p>
			</div>
		);
		...
		<div>
			<div className="section">
				...
				<p style={{ marginBottom: "15px" }}>
					Actors can access metadata about themselves including their
					name, tags, and region. This information is useful for
					logging, monitoring, and conditional behavior.
				</p>
			...
			<div className="section">
				<h3>Actor State</h3>
				<p style={{ marginBottom: "15px" }}>
					Current state of the actor. This state is shared across all
					connections to the actor.
				</p>
			...
			<div className="section">
				...
				<p style={{ marginBottom: "15px" }}>
					State specific to the current connection. Each connection
