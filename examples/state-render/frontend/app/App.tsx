...
export function App() {
	...
	const chatRoom = useActor({ name: "chatRoom", key: ["lobby"] });
	...
	chatRoom.useEvent("messagesCleared", () => setMessages([]));
	...
	const clear = async () => {
		if (chatRoom.connection) await chatRoom.connection.clearMessages();
	};
				...
				<div className="w-full max-w-md">
					<Card variant="outlined" className="border-dashed border-border/80 text-center">
						...
						<CardContent className="flex justify-center pt-0">
							<a
								href="https://render.com/deploy?repo=https://github.com/rivet-dev/rivet/tree/main/examples/state-render"
								target="_blank"
