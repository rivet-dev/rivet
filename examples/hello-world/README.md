...
- **Actor Definition and Server Setup** ([`src/index.ts`](https://github.com/rivet-dev/rivet/tree/main/examples/hello-world/src/index.ts)): Counter actor with persistent state, broadcast events, and the RivetKit registry
