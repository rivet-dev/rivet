> **Note:** This is the Vercel-optimized version of the [state-render](../state-render) example.
> It uses the `hono/vercel` adapter and is configured for Vercel deployment.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Frivet-dev%2Frivet%2Ftree%2Fmain%2Fexamples%2Fstate-render-vercel&project-name=state-render-vercel)
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/rivet-dev/rivet/tree/main/examples/state-render)
