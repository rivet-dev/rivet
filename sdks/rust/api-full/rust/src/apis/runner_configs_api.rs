...
pub async fn runner_configs_list(configuration: &configuration::Configuration, namespace: &str, limit: Option<i32>, cursor: Option<&str>, variant: Option<models::RunnerConfigVariant>, runner_names: Option<&str>) -> Result<models::RunnerConfigsListResponse, Error<RunnerConfigsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_namespace = namespace;
    let p_limit = limit;
    let p_cursor = cursor;
...
pub async fn runner_configs_upsert(configuration: &configuration::Configuration, runner_name: &str, namespace: &str, runner_configs_upsert_request_body: models::RunnerConfigsUpsertRequestBody) -> Result<serde_json::Value, Error<RunnerConfigsUpsertError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_runner_name = runner_name;
    let p_namespace = namespace;
