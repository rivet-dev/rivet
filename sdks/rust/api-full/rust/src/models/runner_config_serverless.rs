...
impl RunnerConfigServerless {
    pub fn new(headers: std::collections::HashMap<String, String>, max_runners: i32, min_runners: i32, request_lifespan: i32, runners_margin: i32, slots_per_runner: i32, url: String) -> RunnerConfigServerless {
