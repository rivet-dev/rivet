...
The developer group has been deactivated. Please [contact support](https://rivet.dev/support) if you believe
this is a mistake.
...
1. Visit https://dashboard.rivet.dev/
...
If needed, feel free to [contact support](https://rivet.dev/support) for further assistance.

# Reason: `Banned`

The developer group has been banned from using Rivet services. Please
[contact support](https://rivet.dev/support) if you believe this is a mistake.
...
<Summary>{`REQUEST_QUERY_FIELD_NOT_GROUPABLE`}</Summary>
...
<Summary>{`REQUEST_QUERY_FIELD_NOT_MAP`}</Summary>
...
<Summary>{`REQUEST_QUERY_INVALID_GROUP_BY_FIELD`}</Summary>
...
<Summary>{`REQUEST_QUERY_MAP_REQUIRES_KEY`}</Summary>
