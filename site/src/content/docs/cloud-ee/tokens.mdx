...
```bash
curl -H "Authorization: Bearer $RIVET_SERVICE_TOKEN" 'https://api.rivet.dev/actors?project=my-project&environment=prod'
```
...
See the [`rivet shell` documentation](/docs/cloud/cli#shell) for more information.
