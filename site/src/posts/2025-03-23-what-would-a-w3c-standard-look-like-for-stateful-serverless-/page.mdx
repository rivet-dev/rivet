...
Unless you're deep in to <Link href="https://developers.cloudflare.com/durable-objects/" target="_blank">Cloudflare Durable Objects</Link> or <Link href="/docs/actors" target="_blank">Rivet Actors</Link>, there's a good chance you've never heard of "stateful serverless."
