...
<Lead>
  We're Rivet, a new open-source, self-hostable serverless platform. We've been in the weeds with SQLite-on-the-server recently and – boy – do we have a lot of thoughts to share. [Give us a star on GitHub](https://github.com/rivet-dev/rivet), we'll be sharing a lot more about SQLite soon!
</Lead>
...
<Tip>
  We're shipping an open-source & self-hostable alternative to Cloudflare Durable Objects with SQLite in the near future. Follow us on [X](https://x.com/rivet_dev), [Bluesky](https://bsky.app/profile/rivet.gg), or [Discord](https://rivet.gg/discord) to get notified on updates.
</Tip>
