...
**Rivet is an open-source, self-hostable serverless alternative to Cloudflare Workers, Durable Objects, and Containers. Check out [Rivet Containers](/docs/cloud/containers) and [visit our GitHub](https://github.com/rivet-dev/rivet).**
