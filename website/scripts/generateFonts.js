...
let fonts = [];
fonts.push(
	...fs.readdirSync(path.join(__dirname, "../public/fonts/open-sans")),
);
...
fonts.push(
	...fs.readdirSync(path.join(__dirname, "../public/fonts/darker-grotesque")),
);
fonts.push(
	...fs.readdirSync(path.join(__dirname, "../public/fonts/silkscreen")),
);
...
fonts.push(
	...fs.readdirSync(path.join(__dirname, "../public/fonts/cartridge")),
);
fonts.push(
	...fs.readdirSync(
		path.join(__dirname, "../public/fonts/perfectly-nineties"),
	),
);
fonts.push(
	...fs.readdirSync(
		path.join(__dirname, "../public/fonts/gloria-hallelujah"),
	),
);
...
fonts = fonts
	.filter(
		(file) =>
			path.extname(file) === ".ttf" || path.extname(file) === ".otf",
	)
