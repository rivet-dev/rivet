	...
	const tutorials = [
		{
			...
			description:
				"Build intelligent agents that maintain conversation context & tool calls",
			icons: [faRobot],
		...
		},
		{
			...
			description:
				"Create collaborative apps with real-time synchronization",
			icons: [faCodeMerge],
		...
		},
		{
			...
			description:
				"Execute user or LLM-generated code safely with isolation",
			icons: [faCode],
		...
		},
		{
			...
			description:
				"Process and transform data streams with persistent state",
			icons: [faWaveSine],
		...
		<div className="mx-auto max-w-7xl px-6 py-28 lg:py-44 lg:px-8 mt-16">
			<div className="text-center mb-12">
				...
				<p className="mt-4 text-lg text-white/70">
					Follow our step-by-step tutorials to deploy your first
					project quickly
				</p>
			</div>
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
				{tutorials.map((tutorial, index) => (
					<a key={index} href={tutorial.href} className="group">
