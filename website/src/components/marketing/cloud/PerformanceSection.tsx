...
export const PerformanceSection = () => {
	const stats = [
		...
		},
		{
			...
			icon: faChartLine,
			description:
				"Handles any load on demand without manual configuration",
		},
		{
			title: "Minimize Idle CPU Time",
			icon: faLeaf,
			description:
				"Optimize wasted CPU time or costs for long-running and realtime applications",
		},
	];
				...
				<div className="flex flex-col md:flex-row gap-12">
					...
					<div className="md:w-2/5">
						...
						<p className="text-white/60">
							Deploy your serverless applications globally with
							low latency and zero cold starts
						</p>
					</div>
