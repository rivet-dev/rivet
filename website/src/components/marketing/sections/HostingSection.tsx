  ...
  <section className='border-t border-ink/10 py-16 md:py-32'>
    <div className='mx-auto max-w-7xl px-6'>
      ...
      >
        ...
        <div className='flex flex-col border-t border-ink/10 pt-6'>
          <div className='mb-3 flex items-center gap-2.5'>
            ...
            <h3 className='text-base font-medium text-ink'>Just a Library</h3>
          </div>
          ...
          <div className='mt-auto pt-6'>
            <InkChip variant='paper' command='npm install rivetkit' className='mb-4 max-w-fit' />
            <a
        ...
        <div className='flex flex-col border-t border-ink/10 pt-6'>
          <div className='mb-3 flex items-center gap-2.5'>
            ...
            <h3 className='text-base font-medium text-ink'>Rivet Cloud</h3>
          </div>
          <p className='text-sm leading-relaxed text-ink-soft'>
        ...
        <div className='flex flex-col border-t border-ink/10 pt-6'>
          <div className='mb-3 flex items-center gap-2.5'>
            ...
            <h3 className='text-base font-medium text-ink'>Self-Host</h3>
          </div>
          <p className='text-sm leading-relaxed text-ink-soft'>
          ...
          <div className='mt-auto pt-6'>
            <InkChip variant='paper' command='docker run -p 6420:6420 rivetdev/engine' className='mb-4 max-w-fit' />
            <a
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.5, delay: 0.1 }}
        className='mt-12 flex flex-wrap items-center gap-x-2 gap-y-2 border-t border-ink/10 pt-6'
      >
