...
const getStartedTabs: { icon: typeof Bot; label: string; code: React.ReactNode }[] = [
	{ icon: Bot, label: 'Agent', code: <>{kw('import')} {'{ '}{vr('AgentOs')}{' }'} {kw('from')} {str('"@rivet-dev/agent-os"')}{op(';')}{br}{br}{kw('const')} {vr('vm')} {op('=')} {kw('await')} {vr('AgentOs')}{op('.')}{fn_('create')}{op('()')}{op(';')}{br}{kw('await')} {vr('vm')}{op('.')}{fn_('prompt')}{op('(')}{str('"Write a Python script that calculates pi"')}{op(')')}{op(';')}</> },
	{ icon: Wrench, label: 'Expose tools', code: <>{kw('import')} {'{ '}{vr('AgentOs')}{' }'} {kw('from')} {str('"@rivet-dev/agent-os"')}{op(';')}{br}{br}{kw('const')} {vr('vm')} {op('=')} {kw('await')} {vr('AgentOs')}{op('.')}{fn_('create')}{op('()')}{op(';')}{br}{vr('vm')}{op('.')}{vr('tools')}{op('.')}{fn_('register')}{op('(')}{str('"search"')}{op(', {')} {br}{'  '}{vr('description')}{op(':')} {str('"Search the web"')}{op(',')}{br}{'  '}{vr('parameters')}{op(':')} {'{ '}{vr('query')}{op(':')} {str('"string"')}{' }'}{op(',')}{br}{'  '}{fn_('handler')}{op(':')} {kw('async')} {op('(')}{op('{ ')}{vr('query')}{op(' }')}{op(')')} {op('=>')} {'{'}{br}{'    '}{kw('return')} {kw('await')} {fn_('fetch')}{op('(')}{str('`/api/search?q=${')}{vr('query')}{str('}`')}{op(')')}{op(';')}{br}{'  }'}{br}{op('});')}</> },
	{ icon: CalendarClock, label: 'Cron jobs', code: <>{kw('import')} {'{ '}{vr('AgentOs')}{' }'} {kw('from')} {str('"@rivet-dev/agent-os"')}{op(';')}{br}{br}{kw('const')} {vr('vm')} {op('=')} {kw('await')} {vr('AgentOs')}{op('.')}{fn_('create')}{op('()')}{op(';')}{br}{vr('vm')}{op('.')}{fn_('cron')}{op('(')}{str('"0 */6 * * *"')}{op(',')} {kw('async')} {op('()')} {op('=>')} {'{'}{br}{'  '}{kw('await')} {vr('vm')}{op('.')}{fn_('prompt')}{op('(')}{str('"Check for dependency updates"')}{op(')')}{op(';')}{br}{'}'}{op(')')}{op(';')}</> },
	{ icon: ExternalLink, label: 'Preview URLs', code: <>{kw('import')} {'{ '}{vr('AgentOs')}{' }'} {kw('from')} {str('"@rivet-dev/agent-os"')}{op(';')}{br}{br}{kw('const')} {vr('vm')} {op('=')} {kw('await')} {vr('AgentOs')}{op('.')}{fn_('create')}{op('()')}{op(';')}{br}{kw('const')} {vr('url')} {op('=')} {kw('await')} {vr('vm')}{op('.')}{fn_('preview')}{op('(')}{num('3000')}{op(')')}{op(';')}{br}{vr('console')}{op('.')}{fn_('log')}{op('(')}{str('`Preview: ${')}{vr('url')}{str('}`')}{op(')')}{op(';')}</> },
	{ icon: Activity, label: 'Observability', code: <>{kw('import')} {'{ '}{vr('AgentOs')}{' }'} {kw('from')} {str('"@rivet-dev/agent-os"')}{op(';')}{br}{br}{kw('const')} {vr('vm')} {op('=')} {kw('await')} {vr('AgentOs')}{op('.')}{fn_('create')}{op('()')}{op(';')}{br}{vr('vm')}{op('.')}{fn_('on')}{op('(')}{str('"process:start"')}{op(',')} {op('(')}{vr('proc')}{op(')')} {op('=>')} {'{'}{br}{'  '}{vr('console')}{op('.')}{fn_('log')}{op('(')}{str('`Started: ${')}{vr('proc')}{op('.')}{vr('command')}{str('}`')}{op(')')}{op(';')}{br}{'}'}{op(')')}{op(';')}{br}{vr('vm')}{op('.')}{fn_('on')}{op('(')}{str('"process:exit"')}{op(',')} {op('(')}{vr('proc')}{op(')')} {op('=>')} {'{'}{br}{'  '}{vr('console')}{op('.')}{fn_('log')}{op('(')}{str('`Exited: ${')}{vr('proc')}{op('.')}{vr('command')}{str('} (${')}{vr('proc')}{op('.')}{vr('exitCode')}{str('})` ')}{op(')')}{op(';')}{br}{'}'}{op(')')}{op(';')}</> },
	{ icon: HardDrive, label: 'File system', code: <>{kw('import')} {'{ '}{vr('AgentOs')}{' }'} {kw('from')} {str('"@rivet-dev/agent-os"')}{op(';')}{br}{br}{kw('const')} {vr('vm')} {op('=')} {kw('await')} {vr('AgentOs')}{op('.')}{fn_('create')}{op('()')}{op(';')}{br}{kw('await')} {vr('vm')}{op('.')}{vr('fs')}{op('.')}{fn_('write')}{op('(')}{str('"/workspace/hello.txt"')}{op(',')} {str('"Hello, world!"')}{op(')')}{op(';')}{br}{kw('const')} {vr('content')} {op('=')} {kw('await')} {vr('vm')}{op('.')}{vr('fs')}{op('.')}{fn_('read')}{op('(')}{str('"/workspace/hello.txt"')}{op(')')}{op(';')}{br}{kw('const')} {vr('files')} {op('=')} {kw('await')} {vr('vm')}{op('.')}{vr('fs')}{op('.')}{fn_('list')}{op('(')}{str('"/workspace"')}{op(')')}{op(';')}</> },
];
