...
// --- Hero ---
const Hero = () => (
	<section className="relative overflow-hidden pb-20 pt-32 md:pb-24 md:pt-48">
		<div className="mx-auto max-w-4xl px-6 text-center">
			<motion.p
				initial={{ opacity: 0, y: 20 }}
				animate={{ opacity: 1, y: 0 }}
				transition={{ duration: 0.5 }}
				className="mb-6 font-mono text-xs font-semibold uppercase tracking-widest text-zinc-500"
			>
			...
			<motion.h1
				...
				className="mb-6 text-4xl font-extrabold leading-[1.1] tracking-tight text-white md:text-6xl"
			>
...
const DesignPrinciples = () => {
	const principles = [
		...
		},
		{
			...
			title: "Scale to zero",
			description:
				"Millions of agents, most idle. Pay for what runs. Wake instantly when needed. No cold starts, no wasted capacity.",
		},
		{
			number: "06",
