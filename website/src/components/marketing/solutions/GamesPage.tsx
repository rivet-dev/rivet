			...
			<div className="flex flex-col lg:flex-row gap-16 items-center">
				<div className="flex-1 max-w-2xl">
					...
					>
						...
						<a href="/docs/games" className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md border border-white/10 px-4 py-2 text-sm text-zinc-300 transition-colors hover:border-white/20 hover:text-white">
							View Documentation
						</a>
					</motion.div>
				</div>
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div className="space-y-6">
						...
						>
							...
							<h3 className="mb-1 text-sm font-normal text-white">Authoritative Logic</h3>
						...
						>
							...
							<h3 className="mb-1 text-sm font-normal text-white">Instant Connectivity</h3>
							<p className="text-zinc-500 text-sm leading-relaxed">
						...
						>
							...
							<h3 className="mb-1 text-sm font-normal text-white">Persistence on Exit</h3>
							<p className="text-zinc-500 text-sm leading-relaxed">
			...
			<div className="grid md:grid-cols-2 gap-16 items-center">
				...
				<div className="relative rounded-lg border border-white/10 bg-black p-6">
					<div className="flex items-center justify-between mb-6 border-b border-white/5 pb-4">
						...
						<div className="rounded border border-[#FF4500]/20 bg-[#FF4500]/10 px-2 py-1 text-xs text-[#FF4500]">Live</div>
					</div>
