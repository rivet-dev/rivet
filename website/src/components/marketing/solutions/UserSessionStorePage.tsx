					...
					<div className="relative h-80 rounded-2xl border border-white/10 bg-zinc-900/20 flex flex-col items-center justify-center overflow-hidden p-8">
						<div className="relative w-full h-full flex items-center justify-between z-10 px-8">
							...
							<div className="flex-1 h-[2px] bg-zinc-800 relative mx-4 overflow-hidden">
								{/* Packet */}
								<div className={`absolute top-0 left-0 h-full w-12 bg-cyan-400 blur-[2px] transition-all duration-1000 linear ${step === 1 ? "translate-x-full opacity-100" : "translate-x-0 opacity-0"}`} />
								<div className={`absolute top-0 right-0 h-full w-12 bg-cyan-400 blur-[2px] transition-all duration-1000 linear ${step === 3 ? "-translate-x-full opacity-100" : "translate-x-0 opacity-0"}`} style={{ transform: step === 3 ? "translateX(-500%)" : "translateX(0)" }} />
							</div>
