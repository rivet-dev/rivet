...
const PRODUCT_PAGES = [
	...
	},
	{
		...
		description:
			"View version history & roll back instantly without re-deploying.",
				...
				<motion.div
					...
					onDragEnd={(e, { offset, velocity }) => {
						...
						if (swipe < -swipeConfidenceThreshold) {
							onChangePage(
								paginate(page.index, 1, PRODUCT_PAGES),
							);
...
function ProductPageContents({ page, scale }) {
	return (
		<>
			<p className="text-cream-100 text-center max-w-xl">
				{page.description}
			</p>
