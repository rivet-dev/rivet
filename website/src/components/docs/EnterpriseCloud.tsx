...
export function EnterpriseCloud() {
	return (
		<Info>
			...
			<p>Please <a href="/sales">reach out for access</a> for access to Rivet Cloud. To deploy RivetKit without Rivet Cloud, see our <a href="/docs/general/self-hosting">self-hosting documentation</a>.</p>
		</Info>
	)
}
