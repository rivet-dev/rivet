...
export const keywords = ["vercel","serverless","tunnel","websocket","realtime","actor","lobby"]
...
<Image src={imgNoTunneling} alt="No tunneling diagram" />
...
<Image src={imgTunneling1} alt="Setting up tunnel" />
...
<Image src={imgTunneling2} alt="Forwarding request via tunnel" />
...
<Image src={imgTunnelRivet1} alt="Tunnel Rivet 1" />
...
<Image src={imgTunnelRivet2} alt="Tunnel Rivet 2" />
...
<Image src={imgTunnelRivet3} alt="Tunnel Rivet 3" />
...
<Image src={imgTunnelRivet4} alt="Tunnel Rivet 4" />

**Step 5: Send request response**

The Vercel Function will acknowledge the WebSocket as opened.

<Image src={imgTunnelRivet5} alt="Tunnel Rivet 5" />
...
<Accordion title="Want to learn more about the nitty gritty of the tunnel protocol?">
	...
	<Image src={imgTunnelProtocol} alt="Tunnel protocol" />
...
<Image src={imgMultipleWs} alt="Multiple WebSockets" />
