...
description: "Durable cron jobs and scheduled tasks with Rivet Actors. Use c.schedule.after and c.schedule.at for persistent timers that survive restarts, deploys, and crashes, plus recurring jobs that re-arm themselves, idempotent handlers, and singleton job actors."
...
<AccordionGroup>
<Accordion title='reminderActor["main"]'>
