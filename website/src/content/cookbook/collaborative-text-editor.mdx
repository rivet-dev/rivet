...
description: "Build a collaborative text editor backend with Yjs CRDTs and Rivet Actors: a per-document actor relays CRDT document sync and awareness updates to every collaborator, persists merged Yjs snapshots in actor KV, and a coordinator actor indexes documents per workspace."
templates: ["collaborative-document"]
---
...
<AccordionGroup>
<Accordion title="document[workspaceId, documentId]">
...
<Accordion title="documentList[workspaceId]">
