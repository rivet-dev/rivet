---
title: "Building a Realtime Chat App with Actors"
description: "In this guide, we're building a realtime chat application using the Rivet library. The app consists of:"
---
