...
agentOS is not supported on Cloudflare Workers because it requires a Node.js or
container host. It supports platforms such as Railway, Kubernetes, and Vercel.
