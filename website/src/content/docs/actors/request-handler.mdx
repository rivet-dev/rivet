...
<CodeSnippet file="examples/docs/actors-request-handler/raw-http.ts" />

</Tab>
<Tab title="Hono">

<CodeSnippet file="examples/docs/actors-request-handler/hono.ts" />
...
<CodeGroup>
<CodeSnippet file="examples/docs/actors-request-handler/via-client/client.ts" title="client.ts" />
</CodeGroup>
...
<CodeGroup>
<CodeSnippet file="examples/docs/actors-request-handler/via-gateway/client.ts" title="client.ts" />
</CodeGroup>
...
<CodeSnippet file="examples/docs/actors-request-handler/http-api-fetch.ts" region="fetch" />
...
<CodeSnippet file="examples/docs/actors-request-handler/proxy.ts" />
