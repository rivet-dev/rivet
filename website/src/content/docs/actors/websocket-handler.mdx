...
<CodeSnippet file="examples/docs/actors-websocket-handler/chat-actor.ts" />
...
<CodeSnippet file="examples/docs/actors-websocket-handler/proxy.ts" />
...
<CodeSnippet file="examples/docs/actors-websocket-handler/hibernation.ts" />
...
<CodeSnippet file="examples/docs/actors-websocket-handler/accessing-request.ts" />
...
<CodeSnippet file="examples/docs/actors-websocket-handler/async-handler.ts" />
