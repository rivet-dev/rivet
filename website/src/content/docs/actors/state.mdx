...
<CodeSnippet file="examples/docs/actors-state/durable-basic.ts" title="Basic" />

<CodeSnippet file="examples/docs/actors-state/durable-dynamic-init.ts" title="Dynamic init" />

<CodeSnippet file="examples/docs/actors-state/durable-with-input.ts" title="With input" />
...
<CodeSnippet file="examples/docs/actors-state/ephemeral-basic.ts" title="Basic" />

<CodeSnippet file="examples/docs/actors-state/ephemeral-dynamic-init.ts" title="Dynamic init" />
...
<CodeSnippet file="examples/docs/actors-state/save-state.ts" />
...
<CodeSnippet file="examples/docs/actors-state/runtime-objects.ts" />
