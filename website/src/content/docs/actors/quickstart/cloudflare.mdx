...
<CodeSnippet file="examples/docs/actors-quickstart-cloudflare/client.ts" title="client.ts" />
...
<CodeSnippet file="examples/docs/actors-quickstart-cloudflare/Counter.tsx" title="Counter.tsx" />
