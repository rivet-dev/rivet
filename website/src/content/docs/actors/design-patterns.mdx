...
<CodeSnippet file="examples/docs/actors-design-patterns/coordinator-actor.ts" />

</Tab>
<Tab title="Client">

<CodeSnippet file="examples/docs/actors-design-patterns/coordinator-client.ts" />
...
<CodeSnippet file="examples/docs/actors-design-patterns/sharding-time-actor.ts" />

</Tab>
<Tab title="Client">

<CodeSnippet file="examples/docs/actors-design-patterns/sharding-time-client.ts" />
...
<CodeSnippet file="examples/docs/actors-design-patterns/random-sharding-actor.ts" />

</Tab>
<Tab title="Client">

<CodeSnippet file="examples/docs/actors-design-patterns/random-sharding-client.ts" />
...
<CodeSnippet file="examples/docs/actors-design-patterns/map-reduce-actor.ts" />

</Tab>
<Tab title="Client">

<CodeSnippet file="examples/docs/actors-design-patterns/map-reduce-client.ts" />
...
<CodeSnippet file="examples/docs/actors-design-patterns/loading-state-actor.ts" />

</Tab>
<Tab title="Client">

<CodeSnippet file="examples/docs/actors-design-patterns/loading-state-client.ts" />
...
<CodeSnippet file="examples/docs/actors-design-patterns/syncing-state-actor.ts" />

</Tab>
<Tab title="Client">

<CodeSnippet file="examples/docs/actors-design-patterns/syncing-state-client.ts" />
