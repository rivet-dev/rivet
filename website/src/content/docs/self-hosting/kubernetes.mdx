...
Check that all pods are running (you should see 2+ engine pods):
...
- For advanced multi-datacenter setup, see the [GitHub repository](https://github.com/rivet-dev/rivet/tree/main/k8s)
