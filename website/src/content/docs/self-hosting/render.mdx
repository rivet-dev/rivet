...
2. A GitHub repository (you'll add files to it)

## Step 1: Create the Blueprint Files
...
5. Select the repository containing the files from Step 1
6. Click **Apply**
...
4. Copy this token - you'll need it to access the Inspector

## Step 4: Access the Rivet Inspector
...
Enter the admin token from Step 3 to log in.
