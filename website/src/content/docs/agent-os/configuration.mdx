...
This is useful for [sandbox mounting](/docs/agent-os/sandbox) where each instance needs a dedicated container, or for any scenario where options depend on the actor instance.
