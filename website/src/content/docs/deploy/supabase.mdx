...
Supabase Edge Functions run RivetKit. Use the public `@rivetkit/rivetkit-wasm` package, load the wasm file with Deno, and use remote SQLite.
...
- [Cloudflare Workers](/docs/deploy/cloudflare)
