...
Set your Rivet endpoint as a Supabase secret. Include your namespace and token in the URL.

```sh
npx supabase secrets set RIVET_ENDPOINT=https://your-namespace:sk_...@api.rivet.dev
```
