...
```typescript {{"title":"Direct"}}
import { registry } from "./registry";

export default registry.serve();
```

```typescript {{"title":"With Router"}}
...
See [Server Setup](/docs/general/server-setup/) for more configuration options.
...
<Image src={imgServerless} alt="Serverless architecture diagram" />
...
<Image src={imgRunners} alt="Runners architecture diagram" />
