...
| Environment Variable | Description |
|---------------------|-------------|
| `RIVET_POOL` | Pool name the runner joins (default: "default") |
| `RIVET_ENVOY_VERSION` | Version number for the runner. See [Versions & Upgrades](/docs/actors/versions). |
| `RIVET_ENVOY_KIND` | Type of runner |
