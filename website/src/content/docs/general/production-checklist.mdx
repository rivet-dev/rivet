...
- **Set a graceful shutdown period of at least 30 minutes.** Runners need time to drain actors during upgrades. In Kubernetes, set `terminationGracePeriodSeconds: 1800` on the pod spec.
