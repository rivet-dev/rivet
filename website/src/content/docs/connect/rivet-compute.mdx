...
<Note>
Using an AI coding agent? Open **Connect** on the [Rivet dashboard](https://hub.rivet.dev), select **Rivet Cloud**, and paste the one-shot prompt into your agent and have it connect with Rivet Compute for you.
</Note>
...
- A [Rivet Cloud](https://hub.rivet.dev) account and project
...
1. Open the [Rivet dashboard](https://hub.rivet.dev) and navigate to your project
