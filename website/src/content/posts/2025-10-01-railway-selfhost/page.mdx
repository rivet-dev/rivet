...
category: changelog
keywords: ["railway", "self-host", "marketplace", "open-source", "deployment", "stateful", "durable objects alternative", "actors"]
title: "Self-Host Rivet on Railway"
description: "Rivet is now a verified app on the Railway Marketplace. With a few clicks, you can deploy and self-host Rivet on Railway and start building stateful apps anywhere you can run Node.js or Bun—without vendor lock-in."
---
