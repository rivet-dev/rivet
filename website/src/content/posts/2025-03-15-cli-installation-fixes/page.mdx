...
category: changelog
keywords: ["CLI", "Installation", "npm", "npx", "Developer Tools"]
title: "Rivet CLI Installation Update"
description: "We've updated the installation process for the `rivet-cli` package, making it easier than ever to get started with Rivet. This update ensures a seamless setup process whether you're using `npx` or installing globally via `npm`."
---
