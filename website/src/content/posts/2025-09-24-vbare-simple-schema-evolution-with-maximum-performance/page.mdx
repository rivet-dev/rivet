...
- **[RivetKit](https://github.com/rivet-dev/rivet/tree/main/rivetkit-typescript/packages/rivetkit)**
  - [Client protocol](https://github.com/rivet-dev/rivet/tree/main/rivetkit-typescript/packages/rivetkit/schemas/client-protocol)
  - [Persisted state](https://github.com/rivet-dev/rivet/tree/main/rivetkit-typescript/packages/rivetkit/schemas/actor-persist)
...
- [ToClient example](https://github.com/rivet-dev/rivet/blob/main/rivetkit-typescript/packages/rivetkit/schemas/client-protocol/v1.bare#L34)
- [ToServer example](https://github.com/rivet-dev/rivet/blob/main/rivetkit-typescript/packages/rivetkit/schemas/client-protocol/v1.bare#L56)
