...
category: technical
keywords: ["guard","actors","proxy","rust","traefik"]
title: "2,000x faster route propagation by rewriting our Traefik gateway in Rust"
description: "Rivet Guard is our gateway service that handles all incoming traffic to the Rivet platform. Its core responsibilities include:"
---
...
- **[Rivet Actors](/docs/actors) Routing**: Route incoming requests to the correct Rivet Actor or Rivet Container
...
<Frame caption="Old Gateway Architecture With Traefik" className="max-w-3xl mx-auto">
	<img src={imgTraefikArch.src} alt="Architecture of Traefik, API server, and NATS" />
</Frame>
...
<Frame caption="New Rivet Guard Architecture" className="max-w-4xl mx-auto">
	<img src={imgRivetGuardArch.src} alt="Rivet Guard and FoundationDB architecture" />
</Frame>
...
<Frame caption="Configuring Rivet Guard" className="max-w-2xl mx-auto">
	<img src={imgRivetStack.src} alt="Rivet Guard stack" />
</Frame>
...
<Frame caption="Create Container Sequence" className="max-w-3xl mx-auto">
	<img src={imgColdStarts.src} alt="Diagram of cold start events with and without Rivet Guard" />
</Frame>
...
- We care a lot about portability & being able to run all of Rivet in a single container for a full local dev environment ([single container docs](https://rivet.dev/docs/cloud/self-hosting/single-container))
