...
RivetKit now provides an OpenAPI spec to integrate your own clients. See the full [openapi.json](https://github.com/rivet-dev/rivetkit/blob/d21e3ec447654a921a72cb47c9dca480ce6d78df/docs/openapi.json).
...
- **GitHub**: [github.com/rivet-dev/rivetkit](https://github.com/rivet-dev/rivetkit)
