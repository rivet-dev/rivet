...
<img src={imgContainerVsIsolate.src} alt="Container-backed execution environments retain assigned capacity through idle stretches, while isolates share a process and return capacity to the pool between work." />
