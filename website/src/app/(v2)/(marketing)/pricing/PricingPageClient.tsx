      ...
      <section className="py-24 bg-black border-y border-white/10 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="mb-20 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-medium text-white mb-6 tracking-tight">The Hybrid Architecture</h2>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center">
             ...
             {/* Connection Line 1 */}
             <div className="relative flex-col lg:flex-row flex items-center justify-center -my-1 lg:my-0 lg:-mx-1 z-10">
             ...
             <div className="relative flex-col lg:flex-row flex items-center justify-center z-10 w-full lg:w-auto">
                 
                 {/* Desktop: The Branch Connector */}
                 <div className="hidden lg:flex flex-col h-[300px] w-24 relative">
                    {/* The Vertical Bus Bar */}
                    <div className="absolute left-0 top-[17%] bottom-[17%] w-[2px] bg-zinc-800">
                    ...
                    {/* Top Branch */}
                    <div className="absolute top-[17%] left-0 w-full h-[2px] bg-zinc-800">
                    ...
                    {/* Middle Branch */}
                    <div className="absolute top-1/2 -translate-y-1/2 left-0 w-full h-[2px] bg-zinc-800">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#FF4500] to-transparent w-1/2 animate-[flow-h_2s_linear_infinite_0.5s]" />
                    </div>

                    {/* Bottom Branch */}
                    <div className="absolute bottom-[17%] left-0 w-full h-[2px] bg-zinc-800">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#FF4500] to-transparent w-1/2 animate-[flow-h_2s_linear_infinite_0.5s]" />
                    </div>
                 </div>
             ...
             <div className="w-full max-w-[280px] flex flex-col gap-6 relative z-10">
                {/* 1. Docker */}
