      ...
      <div className="flex flex-col items-center text-center">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-zinc-400 leading-relaxed mb-8 max-w-2xl mx-auto">
             Rivet Cloud handles the coordination, networking, and persistence across regions—connecting your AWS, Vercel, or Railway deployments instantly.
          </p>
      ...
      <section className="py-24 bg-black border-y border-white/10 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center">
            <h2 className="text-3xl md:text-4xl font-medium text-white mb-6 tracking-tight">The Hybrid Architecture</h2>
            <p className="text-zinc-400 max-w-2xl mx-auto text-lg leading-relaxed">
                Rivet Cloud provides the orchestration layer, managing lifecycle, networking, and state, while your actors run directly on your own compute instances.
            </p>
          </div>
  
          <div className="relative h-[500px] w-full rounded-2xl border border-white/10 bg-zinc-900/20 flex items-center justify-center overflow-hidden p-8">
             {/* Layer 1: Rivet Cloud (Top) */}
             <div className="absolute top-[15%] w-full max-w-4xl left-1/2 -translate-x-1/2 px-4 z-20">
                <div className="relative bg-zinc-950 border border-[#FF4500]/50 px-8 py-4 rounded-xl shadow-[0_0_50px_rgba(255,69,0,0.15)] flex items-center gap-4 w-full">
                    <div className="w-3 h-3 rounded-full bg-[#FF4500]" />
                    <span className="text-[#FF4500] font-medium tracking-widest text-sm uppercase">Rivet Cloud</span>
                    <div className="h-4 w-[1px] bg-white/10" />
                    <span className="text-zinc-500 text-xs font-mono">State • Routing • Orchestration</span>
                </div>
             </div>

             {/* Connecting Beams - Aligned with grid columns */}
             <div className="absolute top-[25%] bottom-[15%] w-full max-w-4xl left-1/2 -translate-x-1/2 grid grid-cols-3 gap-8 px-8 pointer-events-none z-10">
                 {/* Beam 1 - Your Container */}
                 <div className="relative flex justify-center h-full">
                     <div className="absolute top-0 w-[2px] h-full bg-gradient-to-b from-[#FF4500]/50 to-transparent" />
                     <div className="absolute top-0 w-[2px] h-8 bg-[#FF4500] animate-[drop_2s_infinite]" />
                 </div>
                 
                 {/* Beam 2 - Your Function */}
                 <div className="relative flex justify-center h-full">
                     <div className="absolute top-0 w-[2px] h-full bg-gradient-to-b from-[#FF4500]/50 to-transparent" />
                     <div className="absolute top-0 w-[2px] h-8 bg-[#FF4500] animate-[drop_2s_infinite_0.5s]" />
                 </div>
                 
                 {/* Beam 3 - Your Pod */}
                 <div className="relative flex justify-center h-full">
                     <div className="absolute top-0 w-[2px] h-full bg-gradient-to-b from-[#FF4500]/50 to-transparent" />
                     <div className="absolute top-0 w-[2px] h-8 bg-[#FF4500] animate-[drop_2s_infinite_1s]" />
                 </div>
             </div>

             {/* Layer 2: User Compute (Bottom) */}
             <div className="absolute bottom-[15%] w-full max-w-4xl left-1/2 -translate-x-1/2 grid grid-cols-3 gap-8 px-8 z-20">
                {/* Provider 1 */}
                <div className="bg-zinc-900 border border-white/10 p-6 rounded-xl flex flex-col items-center gap-3 relative group hover:border-white/30 transition-colors">
                    <div className="p-3 bg-white/5 rounded-lg text-white group-hover:text-[#FF4500] transition-colors">
                       <Server className="w-6 h-6" />
                    </div>
                    <div className="text-center">
                        <div className="text-white font-medium text-sm">AWS ECS</div>
                        <div className="text-zinc-500 text-[10px] font-mono mt-1">US-EAST-1</div>
                    </div>
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-zinc-800 text-[10px] px-2 py-0.5 rounded text-zinc-400 border border-white/5 z-30">Your Container</div>
                </div>
                ...
                <div className="bg-zinc-900 border border-white/10 p-6 rounded-xl flex flex-col items-center gap-3 relative group hover:border-white/30 transition-colors">
                    ...
                    <div className="text-center">
                        <div className="text-white font-medium text-sm">Vercel / Fly.io</div>
                        <div className="text-zinc-500 text-[10px] font-mono mt-1">EDGE REGIONS</div>
                    </div>
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-zinc-800 text-[10px] px-2 py-0.5 rounded text-zinc-400 border border-white/5 z-30">Your Function</div>
                </div>
                ...
                <div className="bg-zinc-900 border border-white/10 p-6 rounded-xl flex flex-col items-center gap-3 relative group hover:border-white/30 transition-colors">
                    ...
                    <div className="text-center">
                        <div className="text-white font-medium text-sm">Kubernetes</div>
                        <div className="text-zinc-500 text-[10px] font-mono mt-1">ON-PREM</div>
                    </div>
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-zinc-800 text-[10px] px-2 py-0.5 rounded text-zinc-400 border border-white/5 z-30">Your Pod</div>
                </div>
             </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-8 rounded-2xl border border-[#FF4500]/30 bg-gradient-to-b from-[#FF4500]/10 to-transparent relative overflow-hidden flex flex-col backdrop-blur-sm">
                <div className="absolute top-0 right-0 p-3 bg-[#FF4500] text-black font-medium text-[10px] tracking-widest">RECOMMENDED</div>
                ...
                <p className="text-zinc-400 text-sm mb-8 h-12 leading-relaxed">
                    Focus on your code. We handle the distributed systems engineering, security, backups, and reliability.
                </p>
                
                <div className="space-y-4 flex-grow">
                    <div className="flex items-center justify-between py-3 border-b border-[#FF4500]/10">
                        <span className="text-zinc-400 text-sm">Coordinator</span>
                        <span className="text-white font-mono text-sm">Managed</span>
                    </div>
                    <div className="flex items-center justify-between py-3 border-b border-[#FF4500]/10">
                        <span className="text-zinc-400 text-sm">Database</span>
                        <span className="text-white font-mono text-sm">FoundationDB (HA)</span>
                    </div>
                    <div className="flex items-center justify-between py-3 border-b border-[#FF4500]/10">
            ...
            <div className="p-8 rounded-2xl border border-white/10 bg-white/[0.02] relative flex flex-col backdrop-blur-sm transition-all duration-300 hover:border-white/20 hover:bg-white/[0.05]">
                ...
                <div className="space-y-4 flex-grow">
                    <div className="flex items-center justify-between py-3 border-b border-white/5">
                        <span className="text-zinc-500 text-sm">Coordinator</span>
                        <span className="text-zinc-300 font-mono text-sm">You Manage</span>
                    </div>
                    <div className="flex items-center justify-between py-3 border-b border-white/5">
                        <span className="text-zinc-500 text-sm">Database</span>
                        <span className="text-zinc-300 font-mono text-sm">BYO (FDB/PG)</span>
                    </div>
                    <div className="flex items-center justify-between py-3 border-b border-white/5">
...
const Pricing = () => {
    ...
    const usagePricing = [
        ...
        { resource: "Egress", price: "$0.10", unit: "per GB" },
                ...
                <div className={`grid gap-4 items-start mb-24 transition-all duration-300 ${isCloud ? 'md:grid-cols-2 lg:grid-cols-4' : 'md:grid-cols-2 max-w-4xl mx-auto'}`}>
                    {plans.map((plan, idx) => (
                        ...
                        >
                            ...
                            {plan.highlight && (
                                <>
                                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#FF4500] text-black text-[10px] font-medium px-3 py-1 rounded-full uppercase tracking-wide">
                                        Popular
                                    </div>
                                    {/* Top Shine */}
                            ...
                            <Link
                                href={plan.name === "Enterprise" || plan.name === "Enterprise Support" ? "/sales" : "https://dashboard.rivet.dev"}
...
const CoreComponents = () => {
    const components = [
        { title: "Service Discovery", desc: "Automatically routes WebSocket/HTTP traffic to the specific runner node hosting the actor. Handles migration transparently.", icon: Globe, color: "blue" },
        { title: "State Persistence", desc: "Periodically snapshots actor memory to the configured storage backend. Restores state instantly on crash or restart.", icon: HardDrive, color: "red" },
        { title: "Lifecycle Manager", desc: "Detects idle actors and hibernates them to save compute. Wakes them up on the next incoming message.", icon: RefreshCw, color: "orange" },
        { title: "Distributed Locking", desc: "Ensures only one instance of a specific actor ID runs at any time across the entire cluster.", icon: Lock, color: "zinc" },
        { title: "Runner Interface", desc: "A pluggable driver system that lets Rivet spawn actors on Docker, Kubernetes, Nomad, or bare metal processes.", icon: Terminal, color: "red" },
        { title: "VPC Peering", desc: "Connects the control plane securely to your private subnets for database access.", icon: Network, color: "blue" }
    ];
    ...
    return (
        <section className="py-32 bg-zinc-950 border-t border-white/10">
             <div className="max-w-7xl mx-auto px-6">
                <div className="mb-20">
                    <h2 className="text-3xl font-medium text-white mb-6 tracking-tight">Core Engine Components</h2>
                    <p className="text-zinc-400 max-w-2xl text-lg leading-relaxed">The essential services packed into the Rivet Engine binary.</p>
                </div>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {components.map((f, i) => (
                        <FeatureCard key={i} title={f.title} description={f.desc} icon={f.icon} color={f.color} />
