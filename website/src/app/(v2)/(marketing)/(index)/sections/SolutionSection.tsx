  ...
  return (
    <section className='relative pt-48 md:pt-64'>
      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        {/* Header */}
        <h2 className='section-header mb-16 text-center font-heading text-4xl font-bold tracking-tighter text-text-primary md:text-5xl'>
        ...
        <div className='grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-16'>
          ...
          <div>
            <div className='sticky top-32 z-10 md:top-40'>
              <div
                className='code-box-container relative flex-none overflow-hidden rounded-xl border border-border bg-black'
              ...
              >
                ...
                <div className='flex items-center justify-between border-b border-border px-4 py-3'>
                  ...
                  <span className='font-mono text-sm text-text-secondary'>actor.ts</span>
                </div>
                <div
                  className='code-content overflow-x-auto overflow-y-visible bg-black p-6 font-mono text-sm [scrollbar-width:none] [&::-webkit-scrollbar]:hidden'
                  style={{ transformOrigin: 'center center' }}
                >
                  <pre className='bg-black'>
                    <code className='bg-black'>
                      ...
                      <span className='code-highlight-ref' id='code-ref-3'>
                        ...
                        {'\n'}
                        {'      '}
                        <span className='font-bold text-accent'>c.state</span>.messages.push(userMsg);
                        {'\n'}
                        {'      '}
                        <span className='code-keyword'>const</span> assistantMsg ={' '}
                        <span className='code-keyword'>await</span>{' '}
                        <span className='code-function'>getAIReply</span>(
                        <span className='font-bold text-accent'>c.state</span>.messages);
                        {'\n'}
                        {'      '}
                        <span className='font-bold text-accent'>c.state</span>.messages.push(assistantMsg);
                      </span>
                      {'\n'}
          ...
          <div className='mt-8 md:mt-0'>
            <div className='relative flex flex-col items-center'>
              ...
              <div
                className='section-scale-trigger absolute left-0 right-0 top-0'
                style={{ height: 'calc(10vh + 20vh + 20vh + 20vh + 40vh)', pointerEvents: 'none' }}
              ></div>
              ...
              <div className='code-highlight-step text-center' data-target-code='code-ref-1'>
                ...
                <p className='mx-auto mt-2 max-w-md text-text-secondary'>
                  Declare your state in a simple object. Rivet handles persistence, replication, and storage
                  for you. It's just there.
                </p>
              </div>
              ...
              <div className='code-highlight-step text-center' data-target-code='code-ref-2'>
                ...
                <p className='mx-auto mt-2 max-w-md text-text-secondary'>
                  Write functions that clients can call. These are your entrypoints, just like a serverless
              ...
              <div className='code-highlight-step text-center' data-target-code='code-ref-3'>
                ...
                <p className='mx-auto mt-2 max-w-md text-text-secondary'>
                  Just modify{' '}
                  <code className='rounded bg-border px-1 py-0.5 font-mono text-sm text-accent'>c.state</code>
                  . Reads and writes are instant. No database round-trips, no `await`.
                </p>
              </div>
              ...
              <div className='code-highlight-step text-center' data-target-code='code-ref-4'>
                ...
                <p className='mx-auto mt-2 max-w-md text-text-secondary'>
                  Use{' '}
                  <code className='rounded bg-border px-1 py-0.5 font-mono text-sm text-accent'>
                    c.broadcast
                  </code>{' '}
                  to send events. No external pub/sub or WebSocket server needed. It's built-in.
                </p>
              </div>
