		...
		<section className="py-32 bg-black relative border-t border-white/10">
			<div className="max-w-7xl mx-auto px-6">
				<motion.div
					...
					className="mb-16"
				>
					<h2 className="text-3xl md:text-5xl font-medium text-white mb-6 tracking-tight">How it works</h2>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
					...
					<div className="hidden lg:block relative">
						<div className="sticky top-32">
							<div className="rounded-xl overflow-hidden border border-white/10 bg-zinc-900/50 backdrop-blur-xl shadow-2xl transition-all duration-500 relative">
								{/* Top Shine Highlight */}
