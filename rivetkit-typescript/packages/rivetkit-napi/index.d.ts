...
export declare class ActorContext {
	...
	connectConn(
		params: Buffer,
		request?: JsHttpRequest | undefined | null,
	): Promise<ConnHandle>;
...
export declare class Queue {
	...
	next(
		options?: JsQueueNextOptions | undefined | null,
		signal?: CancellationToken | undefined | null,
	): Promise<QueueMessage | null>;
	nextBatch(
		options?: JsQueueNextBatchOptions | undefined | null,
		signal?: CancellationToken | undefined | null,
	...
	enqueueAndWait(
		name: string,
		body: Buffer,
		options?: JsQueueEnqueueAndWaitOptions | undefined | null,
		signal?: CancellationToken | undefined | null,
	): Promise<Buffer | null>;
	tryNext(
		options?: JsQueueTryNextOptions | undefined | null,
	): QueueMessage | null;
	tryNextBatch(
		options?: JsQueueTryNextBatchOptions | undefined | null,
	): Array<QueueMessage>;
	maxSize(): number;
...
export declare class CoreRegistry {
	...
	handleServerlessRequest(
		...
		onStreamEvent: (...args: any[]) => any,
		cancelToken: CancellationToken,
		config: JsServeConfig,
	): Promise<JsServerlessResponseHead>;
}
