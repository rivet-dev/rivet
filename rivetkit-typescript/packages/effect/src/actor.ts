...
export const context = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(): Effect.Effect<
	ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
	never,
	RivetActorContext
> => RivetActorContext as any;

export const state = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
...
export const updateState = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
	f: (state: TState) => void,
): Effect.Effect<void, never, never> => Effect.sync(() => f(c.state));

export const vars = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
): Effect.Effect<TVars, never, never> => Effect.succeed(c.vars);

export const updateVars = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
	f: (vars: TVars) => void,
...
export const getLog = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.log);

export const getActorId = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.actorId);

export const getName = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.name);

export const getKey = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.key);

export const getRegion = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.region);

export const getSchedule = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.schedule);

export const getConns = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.conns);

export const getClient = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.client());

export const getDb = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.db);

export const getKv = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed(c.kv);

export const getQueue = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
) => Effect.succeed((c as unknown as { queue: unknown }).queue);

export const saveState = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
...
export const waitUntil = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any, A = any, E = any, R = never>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
	effect: Effect.Effect<A, E, R>,
...
export const getAbortSignal = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
): Effect.Effect<AbortSignal, never, never> => Effect.succeed(c.abortSignal);

export const sleep = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
): Effect.Effect<void, never, never> => Effect.sync(() => c.sleep());

export const destroy = <TState, TConnParams, TConnState, TVars, TInput, TDatabase = any>(
	c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
...
export function effect<TState, TConnParams, TConnState, TVars, TInput, TDatabase = any, AEff = void>(
	genFn: (
		c: ActorContext<TState, TConnParams, TConnState, TVars, TInput, TDatabase>,
