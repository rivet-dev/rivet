...
export const EngineConfigSchemaBase = ClientConfigSchemaBase.extend({
	/** Deprecated. Unique key for this envoy. Envoys connecting with a given key will replace any other envoy connected with the same key. */
	envoyKey: z.string().optional(),

	/** How many actors this envoy can run. */
