...
export function writePatchStateRequest(
	bc: bare.ByteCursor,
	x: PatchStateRequest,
): void {
...
export function writeActionRequest(
	bc: bare.ByteCursor,
	x: ActionRequest,
): void {
...
export function readConnectionsRequest(
	bc: bare.ByteCursor,
): ConnectionsRequest {
	return {
		id: bare.readUint(bc),
...
export function writeConnectionsRequest(
	bc: bare.ByteCursor,
...
export function writeRpcsListRequest(
	bc: bare.ByteCursor,
	x: RpcsListRequest,
): void {
	bare.writeUint(bc, x.id);
...
export function writeTraceQueryRequest(
	bc: bare.ByteCursor,
	x: TraceQueryRequest,
): void {
	bare.writeUint(bc, x.id);
...
export function readWorkflowHistoryRequest(
	bc: bare.ByteCursor,
...
export function writeWorkflowHistoryRequest(
	bc: bare.ByteCursor,
...
export function readWorkflowReplayRequest(
	bc: bare.ByteCursor,
...
export function writeWorkflowReplayRequest(
	bc: bare.ByteCursor,
	x: WorkflowReplayRequest,
): void {
	bare.writeUint(bc, x.id);
	write0(bc, x.entryId);
}
...
export function readDatabaseSchemaRequest(
	bc: bare.ByteCursor,
...
export function writeDatabaseSchemaRequest(
	bc: bare.ByteCursor,
	x: DatabaseSchemaRequest,
): void {
	bare.writeUint(bc, x.id);
}
...
export function readDatabaseTableRowsRequest(
	bc: bare.ByteCursor,
...
export function writeDatabaseTableRowsRequest(
	bc: bare.ByteCursor,
	...
	switch (tag) {
		...
		case 7:
			return {
				...
				val: readWorkflowHistoryRequest(bc),
			};
		case 8:
			return {
				tag: "WorkflowReplayRequest",
				val: readWorkflowReplayRequest(bc),
			};
		case 9:
			return {
				tag: "DatabaseSchemaRequest",
				val: readDatabaseSchemaRequest(bc),
			};
		case 10:
			return {
				tag: "DatabaseTableRowsRequest",
				val: readDatabaseTableRowsRequest(bc),
			};
		default: {
			bc.offset = offset;
...
export function readConnectionsResponse(
	bc: bare.ByteCursor,
): ConnectionsResponse {
	return {
...
export function writeConnectionsResponse(
	bc: bare.ByteCursor,
...
export function writeStateResponse(
	bc: bare.ByteCursor,
	x: StateResponse,
): void {
	bare.writeUint(bc, x.rid);
...
export function writeActionResponse(
	bc: bare.ByteCursor,
	x: ActionResponse,
): void {
	bare.writeUint(bc, x.rid);
...
export function readTraceQueryResponse(
	bc: bare.ByteCursor,
): TraceQueryResponse {
	return {
		rid: bare.readUint(bc),
...
export function writeTraceQueryResponse(
	bc: bare.ByteCursor,
...
export function readQueueMessageSummary(
	bc: bare.ByteCursor,
): QueueMessageSummary {
	return {
		id: bare.readUint(bc),
...
export function writeQueueMessageSummary(
	bc: bare.ByteCursor,
	x: QueueMessageSummary,
): void {
	bare.writeUint(bc, x.id);
	bare.writeString(bc, x.name);
...
export function writeQueueResponse(
	bc: bare.ByteCursor,
	x: QueueResponse,
): void {
	bare.writeUint(bc, x.rid);
...
export function readWorkflowHistoryResponse(
	bc: bare.ByteCursor,
...
export function writeWorkflowHistoryResponse(
	bc: bare.ByteCursor,
...
export function readWorkflowReplayResponse(
	bc: bare.ByteCursor,
...
export function writeWorkflowReplayResponse(
	bc: bare.ByteCursor,
	x: WorkflowReplayResponse,
): void {
	bare.writeUint(bc, x.rid);
	write4(bc, x.history);
	bare.writeBool(bc, x.isWorkflowEnabled);
...
export function readDatabaseSchemaResponse(
	bc: bare.ByteCursor,
...
export function writeDatabaseSchemaResponse(
	bc: bare.ByteCursor,
	x: DatabaseSchemaResponse,
): void {
	bare.writeUint(bc, x.rid);
...
export function readDatabaseTableRowsResponse(
	bc: bare.ByteCursor,
...
export function writeDatabaseTableRowsResponse(
	bc: bare.ByteCursor,
	x: DatabaseTableRowsResponse,
): void {
	bare.writeUint(bc, x.rid);
...
export function readWorkflowHistoryUpdated(
	bc: bare.ByteCursor,
...
export function writeWorkflowHistoryUpdated(
	bc: bare.ByteCursor,
	x: WorkflowHistoryUpdated,
): void {
...
export function writeRpcsListResponse(
	bc: bare.ByteCursor,
	x: RpcsListResponse,
): void {
	bare.writeUint(bc, x.rid);
...
export function readConnectionsUpdated(
	bc: bare.ByteCursor,
): ConnectionsUpdated {
	return {
		connections: read1(bc),
	...
	switch (tag) {
		...
		case 1:
			return {
				...
				val: readConnectionsResponse(bc),
			};
		case 2:
		...
		case 6:
			return {
				...
				val: readWorkflowHistoryUpdated(bc),
			};
		case 7:
		...
		case 10:
			return {
				...
				val: readWorkflowHistoryResponse(bc),
			};
		case 11:
			return {
				tag: "WorkflowReplayResponse",
				val: readWorkflowReplayResponse(bc),
			};
		case 12:
		...
		case 14:
			return {
				...
				val: readDatabaseSchemaResponse(bc),
			};
		case 15:
			return {
				tag: "DatabaseTableRowsResponse",
				val: readDatabaseTableRowsResponse(bc),
			};
		default: {
			bc.offset = offset;
			throw new bare.BareError(offset, "invalid tag");
