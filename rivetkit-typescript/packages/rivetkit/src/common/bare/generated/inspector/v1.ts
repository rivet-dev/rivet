...
export function writeEventsRequest(
	bc: bare.ByteCursor,
	x: EventsRequest,
): void {
	bare.writeUint(bc, x.id);
...
export function readClearEventsRequest(
	bc: bare.ByteCursor,
): ClearEventsRequest {
	return {
		id: bare.readUint(bc),
...
export function writeClearEventsRequest(
	bc: bare.ByteCursor,
...
export function writeBroadcastEvent(
	bc: bare.ByteCursor,
	x: BroadcastEvent,
): void {
...
export function writeSubscribeEvent(
	bc: bare.ByteCursor,
	x: SubscribeEvent,
): void {
	bare.writeString(bc, x.eventName);
...
export function writeUnSubscribeEvent(
	bc: bare.ByteCursor,
	x: UnSubscribeEvent,
): void {
	bare.writeString(bc, x.eventName);
...
export function writeEventsResponse(
	bc: bare.ByteCursor,
	x: EventsResponse,
): void {
	bare.writeUint(bc, x.rid);
...
export function writeEventsUpdated(
	bc: bare.ByteCursor,
	x: EventsUpdated,
): void {
	write1(bc, x.events);
