...
export function writeActorSpecifier(
	bc: bare.ByteCursor,
	x: ActorSpecifier,
): void {
...
export function readSubscriptionRequest(
	bc: bare.ByteCursor,
): SubscriptionRequest {
	return {
...
export function writeSubscriptionRequest(
	bc: bare.ByteCursor,
	...
	switch (tag) {
		...
		case 1:
			return {
				...
				val: readSubscriptionRequest(bc),
			};
		default: {
			bc.offset = offset;
			throw new bare.BareError(offset, "invalid tag");
...
export function writeHttpActionRequest(
	bc: bare.ByteCursor,
	x: HttpActionRequest,
): void {
	writeCbor(bc, x.args);
...
export function encodeHttpActionRequest(
	x: HttpActionRequest,
	config?: Partial<bare.Config>,
): Uint8Array {
	const fullConfig = config != null ? bare.Config(config) : DEFAULT_CONFIG;
...
export function readHttpActionResponse(
	bc: bare.ByteCursor,
): HttpActionResponse {
	return {
		output: readCbor(bc),
...
export function writeHttpActionResponse(
	bc: bare.ByteCursor,
...
export function encodeHttpActionResponse(
	x: HttpActionResponse,
	config?: Partial<bare.Config>,
): Uint8Array {
	const fullConfig = config != null ? bare.Config(config) : DEFAULT_CONFIG;
...
export function decodeHttpActionResponse(
	bytes: Uint8Array,
): HttpActionResponse {
	const bc = new bare.ByteCursor(bytes, DEFAULT_CONFIG);
...
export function readHttpQueueSendRequest(
	bc: bare.ByteCursor,
...
export function writeHttpQueueSendRequest(
	bc: bare.ByteCursor,
	x: HttpQueueSendRequest,
): void {
	writeCbor(bc, x.body);
	write0(bc, x.name);
	write4(bc, x.wait);
...
export function encodeHttpQueueSendRequest(
	x: HttpQueueSendRequest,
	config?: Partial<bare.Config>,
): Uint8Array {
	const fullConfig = config != null ? bare.Config(config) : DEFAULT_CONFIG;
...
export function decodeHttpQueueSendRequest(
	bytes: Uint8Array,
): HttpQueueSendRequest {
	const bc = new bare.ByteCursor(bytes, DEFAULT_CONFIG);
...
export function readHttpQueueSendResponse(
	bc: bare.ByteCursor,
): HttpQueueSendResponse {
	return {
...
export function writeHttpQueueSendResponse(
	bc: bare.ByteCursor,
	x: HttpQueueSendResponse,
): void {
	bare.writeString(bc, x.status);
	write1(bc, x.response);
}

export function encodeHttpQueueSendResponse(
	x: HttpQueueSendResponse,
	config?: Partial<bare.Config>,
): Uint8Array {
	const fullConfig = config != null ? bare.Config(config) : DEFAULT_CONFIG;
...
export function decodeHttpQueueSendResponse(
	bytes: Uint8Array,
): HttpQueueSendResponse {
	const bc = new bare.ByteCursor(bytes, DEFAULT_CONFIG);
...
export function writeHttpResponseError(
	bc: bare.ByteCursor,
	x: HttpResponseError,
): void {
	bare.writeString(bc, x.group);
...
export function encodeHttpResponseError(
	x: HttpResponseError,
	config?: Partial<bare.Config>,
): Uint8Array {
	const fullConfig = config != null ? bare.Config(config) : DEFAULT_CONFIG;
...
export function readHttpResolveResponse(
	bc: bare.ByteCursor,
): HttpResolveResponse {
	return {
		actorId: bare.readString(bc),
...
export function writeHttpResolveResponse(
	bc: bare.ByteCursor,
	x: HttpResolveResponse,
): void {
	bare.writeString(bc, x.actorId);
}

export function encodeHttpResolveResponse(
	x: HttpResolveResponse,
	config?: Partial<bare.Config>,
): Uint8Array {
	const fullConfig = config != null ? bare.Config(config) : DEFAULT_CONFIG;
...
export function decodeHttpResolveResponse(
	bytes: Uint8Array,
): HttpResolveResponse {
	const bc = new bare.ByteCursor(bytes, DEFAULT_CONFIG);
