# Frontend (Cloud Staging) Dockerfile
...
RUN --mount=type=cache,id=s/6fcfa400-4a51-4df5-9345-2918f7aca8b7-/pnpm/store,target=/pnpm/store \
...
RUN --mount=type=cache,id=s/6fcfa400-4a51-4df5-9345-2918f7aca8b7-/app/.turbo,target=/app/.turbo \
